...
public class PlayerMovement : MonoBehaviour
{
    ...
    public float speed = 3.0f;          // ความเร็วในการเคลื่อนที่
    ...
    public bool isDance = false;         // สถานะเต้น
    ...
    //------------------------------------------------------------
    GameCotroller gameController; // อ้างอิงถึง GameController
    //------------------------------------------------------------
    ...
    void Start()
    {
        ...
        {
            gameController = GameObject.Find("GameController").GetComponent<GameCotroller>();
        }
        //------------------------------------------------------------
    }
